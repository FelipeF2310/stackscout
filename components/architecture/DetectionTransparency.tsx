...
// understand the project. Pure presentation over detectCapabilitiesWithEvidence()
// output; no recommendation, scoring, or evidence-model changes.

type Status = 'detected' | 'assumption' | 'default'
